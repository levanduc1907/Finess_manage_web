...
import { FoodNewForm } from './items/FoodNewForm';
import { FoodNewSubmit } from './items/FoodNewSubmit';
...
export function FoodNew() {
  ...
  //         return;
  //       }
  //       const result = await FetchApi.getfood(params.id);
  ...
  return (
    <>
      <Helmet>
        <title>
          {Strings.app_name} · {Strings.manage_food}
        </title>
      </Helmet>
